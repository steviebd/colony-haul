...
63. **Pass 56 HOME n** — loaded carts racing Hub chip **HOME n** under YARD on the Hub. Cyan during a raid (BRACE), gold between raids (HOME). World chips only — BRACE inbound / HAUL HOME / HAUL ROLL still own the carts. Seed-7 fires from the opening farm hauls. Tick unchanged.
