...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `60f8c3a57926ac1123dcef8d208429d4c223cb19` |
| GitHub SHA | `862533a08322cf09a583bd667b58abca29b5cc85` |
...
Pass 55 trees match on the three edited paths (byte-identical). Pass 54 PWR n, Pass 53 LARDER Ns, Pass 52 FUSE Ns, Pass 51 YARD n, Pass 50 BAR n, Pass 49 OPEN n, Pass 48 SIT n, Pass 47 OFF n, Pass 46 LOAD n, Pass 45 GUN n, Pass 44 ROLL n, Pass 43 SLOW n, Pass 42 STUCK n, Pass 41 CUT n, Pass 40 RUN n, Pass 39 LAST, Pass 38 HOLD PEEL, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-55 file bytes match.
- Hold order on Auto still lets loaded carts finish the trip (demo / default). GUNS / CREW peel them the same tick.
