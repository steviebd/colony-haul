...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `4e5108a2822a8d17d3b6a7849c901f9c329faad9` |
| GitHub SHA | `4fcf3221bf514dc88fa008de43de55c4c1675835` |
...
Pass 44 trees match on the three edited paths (byte-identical). Pass 43 SLOW n, Pass 42 STUCK n, Pass 41 CUT n, Pass 40 RUN n, Pass 39 LAST, Pass 38 HOLD PEEL, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-44 file bytes match.
