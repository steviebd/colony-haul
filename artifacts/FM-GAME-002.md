...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `87c25c9c40fcf7623ce896ba9b5bff5a4d70fda8` |
| GitHub SHA | `dbd33983abb6ead85941dca89793fb9fbc6354ea` |
...
Pass 39 trees match on the three edited paths (byte-identical). Pass 38 HOLD PEEL, Pass 37 DOWN n, Pass 36 IN +n, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-39 file bytes match.
