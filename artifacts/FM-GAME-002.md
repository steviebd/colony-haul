...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `6dc52daadaa0e83adcb956f06a50fc88b423635e` |
| GitHub SHA | `78ebeb329eee8e154b7f3c6f574779b7b2685095` |
...
Pass 30 trees match on the three edited paths (byte-identical). Pass 29 LARDER, Pass 28 GUN FUSE, Pass 27 CREW UP, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-30 file bytes match.
