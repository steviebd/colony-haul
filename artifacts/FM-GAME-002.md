...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `379098705acaa3c1daa1a90e750b5384b3de06f2` |
| GitHub SHA | `24087cbbfb0aa70edc498f28ad773eb70bda55c0` |
...
Pass 26 trees match on the five edited paths (byte-identical). Pass 25 RAIL LIVE, Pass 24 GUNS UP, Pass 23 PACK IN, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-26 file bytes match.
