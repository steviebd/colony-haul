...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `a027cc93e6f8d67595a3f3783fe1b5de633ceaa4` |
| GitHub SHA | `fc808885c6ece6bab0a8226ad3658d1c3a835684` |
...
Pass 40 trees match on the three edited paths (byte-identical). Pass 39 LAST, Pass 38 HOLD PEEL, Pass 37 DOWN n, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-40 file bytes match.
