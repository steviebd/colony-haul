...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `6ff018ef07a2be3c8c0b0f53172122efe84318f8` |
| GitHub SHA | `144b61ec7bfc3dfabaadcb1820c9e4416f510201` |
...
Pass 41 trees match on the three edited paths (byte-identical). Pass 40 RUN n, Pass 39 LAST, Pass 38 HOLD PEEL, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-41 file bytes match.
