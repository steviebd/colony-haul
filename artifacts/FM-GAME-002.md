...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `d90e8f758cc60057ad08a6311b113a4d9c80e8e1` |
| GitHub SHA | `6c039ff585d8323070e57965c9f9f61f00a8cf2e` |
...
Pass 27 trees match on the five edited paths (byte-identical). Pass 26 GUNS BACK, Pass 25 RAIL LIVE, Pass 24 GUNS UP, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-27 file bytes match.
