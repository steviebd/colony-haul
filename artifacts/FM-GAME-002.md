...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `8f40aa5a4c55012c72ecf4a361a52d7335e30d39` |
| GitHub SHA | `788bee2fd223ea5ed2f1548d19fb420a7851b0d9` |
...
Pass 42 trees match on the three edited paths (byte-identical). Pass 41 CUT n, Pass 40 RUN n, Pass 39 LAST, Pass 38 HOLD PEEL, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-42 file bytes match.
