...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `2ac9e1a35c3cd0e947c3a33f005f5d1a89a4e3b7` |
| GitHub SHA | `07e0b9111c540644e265982be4cd49463559f962` |
...
Pass 38 trees match on the seven edited paths (byte-identical). Pass 37 DOWN n, Pass 36 IN +n, Pass 35 RAID n, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-38 file bytes match.
