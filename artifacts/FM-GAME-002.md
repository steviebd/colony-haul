...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `a027dabdc2f8f6c249bbd37c81a90ca00c2cd14d` |
| GitHub SHA | `9fa0f6d7d23096be4e1632cfc6103d50a6a50d40` |
...
Pass 43 trees match on the three edited paths (byte-identical). Pass 42 STUCK n, Pass 41 CUT n, Pass 40 RUN n, Pass 39 LAST, Pass 38 HOLD PEEL, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-43 file bytes match.
