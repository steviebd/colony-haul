...
| --- | --- |
| Hub-ready | **Yes** |
| Origin SHA | `5bd6d23985b17ab78ea0ebdd770ee45e90b488ce` |
| GitHub SHA | `713711ae8b587b72d83dde63c149b4eecfede496` |
...
Pass 56 trees match on the four edited paths (byte-identical). HOME n Hub chip was aborted. Pass 55 ORE n and prior Hub chips stay shipped but that family is frozen. Pass 54 PWR n, Pass 53 LARDER Ns, Pass 52 FUSE Ns, and prior beats stay on both remotes. Cold clone still has `Assets/`, `Packages/`, `ProjectSettings/`, USB, `playable/`, artifacts tape. Import workflows self-delete.
...
**Pass 56 — this beat (course-correct)**
...
- GitHub SHA ≠ Origin SHA (parallel history); pass-56 file bytes match.
- Course-correct: no new Hub counter chips. Next beats deepen splice / Hold peel / brownout juice.
